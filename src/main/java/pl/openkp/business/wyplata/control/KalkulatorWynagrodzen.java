...
public class KalkulatorWynagrodzen {
    ...
    public Wyplata oblicz(Long pracownikId, Integer rok, Integer miesiac) {
        ...
        wyplata.setSkladkaEmerytalnaPracownika(pracownik.getWynagrodzenie().multiply(PROCENT_EMERYTALNA_PRACOWNIKA).divide(new BigDecimal("100.0"))
                .setScale(2, RoundingMode.HALF_UP));
        wyplata.setSkladkaChorobowaPracownika(pracownik.getWynagrodzenie().multiply(PROCENT_CHOROBOWA_PRACOWNIKA).divide(new BigDecimal("100.0"))
                .setScale(2, RoundingMode.HALF_UP));
        wyplata.setSkladkaRentowaPracownika(pracownik.getWynagrodzenie().multiply(PROCENT_RENTOWA_PRACOWNIKA).divide(new BigDecimal("100.0"))
                .setScale(2, RoundingMode.HALF_UP));
        ...
        wyplata.setZaliczkaPodatkowa(wyplata.getPodstawa().multiply(new BigDecimal("18.0")).divide(new BigDecimal("100.0"))
                .subtract(new BigDecimal("46.34")).setScale(2, RoundingMode.HALF_UP));
        wyplata.setSkladkaZdrowotna(wyplata.getPrzychod().multiply(new BigDecimal("9.0")).divide(new BigDecimal("100.0"))
                .setScale(2, RoundingMode.HALF_UP));
        wyplata.setSkladkaZdrowotnaOdliczona(wyplata.getPrzychod().multiply(new BigDecimal("7.75")).divide(new BigDecimal("100.0"))
                .setScale(2, RoundingMode.HALF_UP));
